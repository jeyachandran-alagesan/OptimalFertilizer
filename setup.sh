...
echo "  - OptimalFertilizer_Approach1.ipynb (Ensemble with EDA - trains models)"
echo "  - OptimalFertilizer_Approach2.ipynb (XGBoost with Feature Engineering)"
echo "  - OptimalFertilizer_GUI.ipynb (Interactive GUI Application)"
echo ""
