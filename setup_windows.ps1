...
Write-Host "  - notebooks/01-OptimalFertilizer_Approach1.ipynb (Ensemble with EDA - trains models)"
Write-Host "  - notebooks/02-OptimalFertilizer_Approach2.ipynb (XGBoost with Feature Engineering)"
Write-Host "  - notebooks/03-OptimalFertilizer_GUI.ipynb (Interactive GUI Application)"
Write-Host ""
